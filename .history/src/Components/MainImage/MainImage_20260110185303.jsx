...
export default function MainImage () {
  return (
    <div className='min-h-screen relative flex justify-center items-center  fixed-img'>
     <div className='flex gap-5 absolute top-4 end-6'>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
       ...
       <button><p className="size-12 bg-white text-2xl flex items-center justify-center  rounded-full p-2">ع</p></button>
     </div>
