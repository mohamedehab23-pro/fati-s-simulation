...
export default function Navbar() {
  return (
   <>
   <div className='lg:relative z-10 py-10 lg:py-0 items-center sticky top-0 lg:bg-transparent bg-white '>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
       ...
       <button><p className="size-12 cursor-pointer bg-gray-100 lg:bg-white text-xl  rounded-full p-2">ع</p></button>
